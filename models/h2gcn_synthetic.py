...
def parse_args():
    ...
    parser.add_argument("--data", required=True,
                        help="Path to dataset directory (contains features.csv, "
                             "labels.csv, edge_index.npy)")
...
def load_synthetic(data_dir, train_percent=0.6, seed=42):
    ...
    edge_index_np = np.load(os.path.join(data_dir, 'edge_index.npy'))
...
G = load_synthetic(args.data, args.train_percent, args.seed)
